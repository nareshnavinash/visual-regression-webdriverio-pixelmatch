...
const referenceDirectory = path.resolve(__dirname, './test/referenceImages/');
...
if (headless) {
    chrome_browser_args = ['--headless', '--no-sandbox', '--disable-gpu', '--disable-dev-shm-usage', '--window-size=1280,720']
    firefox_browser_args = ['-headless']
} else {
    chrome_browser_args = ['--disable-dev-shm-usage', '--window-size=1280,720']
...
exports.config = {
    ...
    //     // }]
    // ],
    services: [runTimeServices, [WdioScreenshot]],
    ...
    onPrepare: function (config, capabilities) {
        ...
        utilities.removeDirectory('./reports/visual-regression/')
    },
    /**
    ...
    before: function (capabilities, specs) {
        ...
        global.referenceDirectory = referenceDirectory;
        global.currentDirectory = currentDirectory;
        global.reportsDirectory = reportsDirectory;
        global.snap = snap;
    },
    /**
    ...
    afterSuite: function (suite) {
        utilities.generateReportHTML('./reports/visual-regression/')
    },
    /**
